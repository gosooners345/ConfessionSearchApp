...
#pragma warning restore IDE0044 // Add readonly modifier
    ...
    public class Catechism : Document
    {
        ...
        /// <summary>
        /// Catechism Question Property 
        /// </summary>
        public string Question { get { return Formatter(this.question); } set { question = Formatter(value); } }
        /// <summary>
        /// Catechism Answer Property
        /// </summary>
        public string Answer { get { return Formatter(this.answer); } set { answer = Formatter(value); } }
        /// <summary>
        ...
        /// <summary>
        /// Filter results by matching fields containing the term
        /// </summary>
        /// <param name="term">Search term</param>
        /// <param name="truncate">Results truncated?</param>
        public void Filter(string term, bool truncate)
        {
            Log.Info("Filter", "Filtering Catechism Results");
            Stopwatch stopwatch = new Stopwatch();
           // int matchTitle = 3, matchTags = 3, matchQuestion = 5, matchAnswer = 5, matchProofs = 1;
            ...
            for (int i = 2; i <= 6; i++)
            {
                #region Experimental Search Method
    ...
    public class Creed : Document
    {
        ...
        public static Creed Parse(string stringField)
        {
            String[] words;
    ...
    public class DocumentList : LibGList<Document>
    {
        ...
        public void Copy(DocumentList sourceDocument)
        {
            this.Clear(); foreach (Document document in sourceDocument)
            {
                this.Add(document.Clone());
            }
        }
        ...
        protected new void ProcessError(string message)
        {
